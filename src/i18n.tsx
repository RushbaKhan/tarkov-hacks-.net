...
const translations: Record<string, Record<string, string>> = {
  ...
  de: {
    'nav.home': 'Startseite',
    'nav.blog': 'Blog',
    'nav.buy': 'Hacks Kaufen',
    'hero.status': 'Unerkannt · Aktualisiert fur EFT Patch',
    'hero.subtitle': 'Aimbot, ESP & Wallhack',
    'hero.description': 'Dominiere jeden Raid in EFTs EFT. EFT Hacks mit unerkanntem Aimbot, vollem ESP, Wallhack und Loot-Highlights.',
    'hero.cta': 'EFT Hacks Kaufen',
    'hero.features': 'Features Ansehen',
    'hero.trust': 'Windows 10 & 11 · Steam · BattlEye · Extern & Unerkannt',
    'meta.title': 'EFT Hacks – Unerkannter Aimbot & ESP fur EFT EFT',
    'meta.description': 'EFT Hacks mit unerkanntem Aimbot und ESP fur EFT EFT.',
  },
  fr: {
    'nav.home': 'Accueil',
    'nav.blog': 'Blog',
  ...
  th: {
    ...
    'hero.cta': 'รับ EFT Hacks',
    'hero.features': 'ดูฟีเจอร์',
    'hero.trust': 'Windows 10 & 11 · Steam · BattlEye · ภายนอก & ตรวจไม่พบ',
    'meta.title': 'EFT Hacks – เอมบอทและ ESP ตรวจไม่พบสำหรับ EFT EFT',
